    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <div className="flex items-center gap-8">
          <Button className="flex-1 border-red-500 text-red-500 font-semibold" variant="outline">
            <svg
          ...
          <Button className="flex-1 border-blue-600 text-blue-600" variant="outline">
            {/* <Facebook /> */}
            Facebook
          </Button>
        </div>
